                    ...
                    <form action="">
                        ...
                        <div class="form-group">
                            ...
                            <div id="divQuestion8Requirement1" hidden>
                                <label for="file15" class="form-label">Proof of Bank Deposit in the amount of PHP20,000/unit.</label>
                                <input class="form-control form-control-mandatory mb-3"  accept=".pdf,.jpg,.jpeg,.png" type="file" id="file15" required multiple>
                            </div>

                            <div id="divQuestion8Requirement2" hidden>
                                <label for="file16" class="form-label">Proof of Bank Deposit in the amount of PHP50,000/unit.</label>
                                <input class="form-control form-control-mandatory mb-3"  accept=".pdf,.jpg,.jpeg,.png" type="file" id="file16" required multiple>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="divQuestion9Requirement1" hidden>
                                <label for="file17" class="form-label">Audited Financial Statement.</label>
                                <input class="form-control form-control-mandatory mb-3"  accept=".pdf,.jpg,.jpeg,.png" type="file" id="file17" required multiple>
                                
                                <label for="file18" class="form-label">LTFRB Motor Vehicle Inspection Report with picture of unit during inspection.</label>
                                <input class="form-control form-control-mandatory mb-3"  accept=".pdf,.jpg,.jpeg,.png" type="file" id="file18" required multiple>
                            </div>
                        ...
                        <div class="form-group"><!-- START -->
                            ...
                            <div id="divQuestion10Requirement1" hidden>
                                ...
                                <div id="divQuestion11Requirement1" hidden>
                                    <label for="file19" class="form-label">Fleet Management System with organized vehicle dispatch procedure.</label>
                                    <input class="form-control form-control-mandatory mb-3"  accept=".pdf,.jpg,.jpeg,.png" type="file" id="file19" required multiple>
                                </div>
                            </div>
                            <hr>                                
                        </div><!-- END -->
                            ...
                            <div id="divQuestion12Requirement1" hidden>
                                ...
                                <div id="divQuestion13Requirement1" hidden>
                                    ...
                                    <div id="divQuestion14Requirement1" hidden>
                                        <label for="file20" class="form-label">Automatic Fare Collection System (AFCS).</label>
                                        <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file20" required multiple>
                                    </div>
                                </div>

                                <div id="divQuestion13Requirement2" hidden>
                                    <label for="file21" class="form-label">Undertaking to comply with the AFCS.</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file21" required multiple>
                                </div>
                            </div>
                            <hr>
                        </div><!-- END -->
                        ...
                        <div class="form-group"><!-- START -->
                            ...
                            <select name="divQuestion15" id="divQuestion15" class="form-control mb-3" required>
                                ...
                                <div id="divQuestion15Requirement1" hidden>
                                    <label for="file22" class="form-label">Undertaking to Comply the Tree Planting requirement pursuant MC 2020-076, in relation to BR No. 021, series of 2021.</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file22" required multiple>
                                </div>
                            <hr>
                        </div><!-- END -->
                        ...
                        <div class="form-group"><!-- START -->
                            ...
                            <select name="divQuestion16" id="divQuestion16" class="form-control mb-3" required>
                                ...
                                <div id="divQuestion16Requirement1" hidden>
                                    <label for="file23" class="form-label">OTS Approved Bus Operator Security Plan as per MC No. 2021-035.</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file23" required multiple>
                                </div>

                                <div id="divQuestion16Requirement2" hidden>
                                    <label for="file23" class="form-label">Valid Department of Tourism (DOT) and Department of Transportation (DOTr) Endorsement Letters per Department Order No. 2013-004 (indicate area of operation).</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file23" required multiple>
                                </div>

                                <div id="divQuestion16Requirement3" hidden>
                                    <label for="file24" class="form-label">Valid Parent-Teacher Association or School Certification/Endorsement Letter Authorizing/Accrediting the School Service (1 Original for presentation and 1 Photocopy).</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file24" required multiple>
                                </div>     

                                <div id="divQuestion16Requirement4" hidden>
                                    <label for="file25" class="form-label">Proof of public need (any of the following) Notarized Hauling Contract with duration, or Authority to Operate in Ports, Trade Centers, Economic Zone and the like.</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file25" required multiple>
                                </div>

                                <div id="divQuestion16Requirement5" hidden>
                                    <label for="file26" class="form-label">Notarized Shuttle Service Contract with duration, time and the specific pick up and drop off points.</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file26" required multiple>
                                </div>

                                <div id="divQuestion16Requirement6" hidden>
                                    <label for="file27" class="form-label">Proof/Certificate of Existence of Endpoint Terminals.</label>
                                    <input class="form-control form-control-mandatory mb-3" accept=".pdf,.jpg,.jpeg,.png" type="file" id="file27" required multiple>
                                </div>
                            <hr>
                        </div><!-- END -->
