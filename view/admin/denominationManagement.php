                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody id="denominationManagementTableBody">
...
<script>
  ...
  // Displaying of DATA 
        ...
        function fetchDenomination() {
            $.ajax({
                url: '../../controller/denomination_management/fetchDenomination.php',
                method: 'GET',
                dataType: 'json',
                success: function (data) {
                    var tbody = $('#denominationManagementTableBody');
                    ...
                    data.forEach(function (denomination) {
                        var row = `<tr>
        ...
        $('#addDenominationManagementModal, #editdenominationManagementModal, #deletedenominationManagementModal, .denominationManagementAddCloseBtn').on('hidden.bs.modal', function (e) {
